...
return [
    ...
    */
    ...
    // Which folder to store files in project, fill in 'public_html', 'resources', 'storage' and so on.
    // You should create routes to serve images if it is not set to public_html.
