                ...
                <div class="x_content">
                    ...
                    <form data-toggle="validator" role="form"  method="POST" enctype="multipart/form-data" action="{{route('promotion.store')}}" class="form-horizontal form-label-left">
                        ...
                        <div class="item form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">รูปภาพ <span class="required">*</span>
                            </label>
                        ...
                        <div class="item form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12">ข้อความบรรยายใต้ภาพ <span class="required">*</span>
                            </label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
