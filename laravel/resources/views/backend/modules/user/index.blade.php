        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                <div class="x_title">
                    ...
                    <div class="navbar-right"><a href="{{url('admin/user/create')}}" class="btn btn-primary"><i class="fa fa-plus"></i> <strong>เพิ่มผู้ใช้</strong>
                        </a>
                    </div>
            ...
            ajax: {
                ...
                {targets: 3, render: function (data, type, row ) {
                    ...
                    if (parseInt(row.role_id) == 1) {
                        label_text += '<h4><span class=\"label label-info\" >' + 'Admin' + '</span></h4>';
                    } else {
                        label_text += '<h4><span class=\"label label-default\" >' + 'User' + '</span></h4>';
                    }
                    label_text += '</div>'
                    return label_text;
                }},
