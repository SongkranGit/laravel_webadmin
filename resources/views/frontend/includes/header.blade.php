...
<head>
    ...
    <link href="{{asset('frontend/js/mainmenu/menu23.css')}}" rel="stylesheet">
    ...
    <!-- owl carousel -->
    <link href="{{asset('frontend/js/carouselowl/owl.transitions.css')}}" rel="stylesheet">
    <link href="{{asset('frontend/js/carouselowl/owl.carousel.css')}}" rel="stylesheet">

    <!-- tabs 2 -->
    <link href="{{asset('frontend/js/tabs2/tabacc.css')}}" rel="stylesheet" />
    <link href="{{asset('frontend/js/tabs2/detached2.css')}}" rel="stylesheet" />

    <!-- tabs -->
    <link rel="stylesheet" type="text/css" href="{{asset('frontend/js/tabs/assets/css/responsive-tabs3.css')}}">

    <!-- accordion -->
    <link rel="stylesheet" type="text/css" href="{{asset('frontend/js/accordion/style.css')}}" />
